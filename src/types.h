...
// Special thanks to Luecx, Zomby(jhonnold), Slender(rafid-dev) and other Openbench Discord Members for their generous
// help of Seraphina NNUE training
...
#define Engine_Name "Seraphina"
#define Engine_Version "v1"
#define Engine_Author "Henry Z"
...
#define MAX_PLY 256
#define ACC_STACK_SIZE (MAX_PLY + 2)
...
enum PieceList : int { PAWN, KNIGHT, BISHOP, ROOK, QUEEN, KING, NO_PIECE };
...
enum MoveType : int { NORMAL, SHORT_CASTLE, LONG_CASTLE, CAPTURE, ENPASSNT, PROMOTION, PROMOTION_CAPTURE };
